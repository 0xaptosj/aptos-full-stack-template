  ...
  return (
    <Card>
      ...
      <CardContent className="flex flex-wrap gap-4">
        <Button onClick={onSignAndSubmitTransaction} disabled={!connected}>
          Sign and submit transaction
        </Button>
        <Button onClick={onSignTransaction} disabled={!connected}>
          Sign transaction
        </Button>
        <Button onClick={onSignMessage} disabled={!connected}>
          Sign message
        </Button>
        <Button onClick={onSignMessageAndVerify} disabled={!connected}>
