export const ABI = {
  address: "0xa87689618690df179975321cf630397ddeea6cc2936b58b6bd22c2b0ce367253",
  name: "message_board",
  friends: [],
  exposed_functions: [
    {
      ...
      generic_type_params: [],
      params: [
        "0x1::object::Object<0xa87689618690df179975321cf630397ddeea6cc2936b58b6bd22c2b0ce367253::message_board::Message>",
      ],
      return: [
        "bool",
        "0x1::string::String",
    ...
    },
    {
      ...
      return: [
        "vector<0x1::object::Object<0xa87689618690df179975321cf630397ddeea6cc2936b58b6bd22c2b0ce367253::message_board::Message>>",
      ],
    },
    {
      name: "post_message",
  ...
  structs: [
    ...
    },
    {
      ...
      fields: [
        {
          name: "messages",
          type: "vector<0x1::object::Object<0xa87689618690df179975321cf630397ddeea6cc2936b58b6bd22c2b0ce367253::message_board::Message>>",
        },
      ],
    },
  ],
